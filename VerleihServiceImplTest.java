...
public class VerleihServiceImplTest
{
    ...
    public void testNochEinTestFall1()
    {
        ...
        //Warum muss man die Methode getMedian() anhängen?

        //verleiht das Medium _abbey
        _verleihService.verleiheAn(_homer, _medien, _datum);

        System.out.println(_verleihService.getVerleihkartenFuer(_homer));

        assertEquals(_abbey, _medien.get(0));

        //testet ob _abbey verliehen wurde
        assertTrue(_verleihService.istVerliehen(_abbey));

        //Testet ob _abbey verliehen ist.

        assertTrue(_verleihService.istVerliehen(_medien.get(0)));
    ...
    {
        List<Medium> _verlieheneMedien = new ArrayList<Medium>();

        _verlieheneMedien.add(_abbey);

        //        System.out.println(_verlieheneMedien.get(0));
        //        System.out.println(_abbey);

        assertEquals(_abbey, _verlieheneMedien.get(0));

        //Testet ob _abbey verliehen ist.

        assertTrue(_verleihService.istVerliehen(_verlieheneMedien.get(0)));
